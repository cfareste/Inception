...
Docker networks work using drivers, software that provides networking functionality. Drivers make networks pluggable, meaning you can modify their behavior by selecting different drivers or installing third-party plugins. There are different types of network drivers:
